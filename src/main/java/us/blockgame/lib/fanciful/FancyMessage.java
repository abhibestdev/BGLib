package us.blockgame.lib.fanciful;
...
import us.blockgame.lib.util.ArrayWrapper;
...
import static us.blockgame.lib.fanciful.TextualComponent.rawText;
...
public class FancyMessage implements JsonRepresentedObject, Cloneable, Iterable<MessagePart>, ConfigurationSerializable {
	...
	*/
    ...
    public void sendXD(Player player) {
        sendXD(player, toJSONString());
    }


    private void sendXD(CommandSender sender, String jsonString) {
        ...
        Bukkit.dispatchCommand(Bukkit.getConsoleSender(), "tellraw " + disguiseHandler.getRealName(player) + " " + jsonString);
    }
